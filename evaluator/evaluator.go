...
func evalPrefixExpression(operator string, right object.Object, env *object.Environment) object.Object {
	switch operator {
	case "!":
		return evalBangOperatorEpression(right)
	case "-":
		return evalMinusOperatorEpression(right)
	default:
		return newError("unknown operator: %s%s", operator, right.Type())
	}
}

func evalBangOperatorEpression(right object.Object) object.Object {
	switch right {
	case TRUE:
		return FALSE
	case FALSE:
...
func evalMinusOperatorEpression(right object.Object) object.Object {
...
func evalHashLiteral(node *ast.HashLiteral, env *object.Environment) object.Object {
	...
	for keyNode, valueNode := range node.Pairs {
		...
		// TODO: check for dupulicate keys here
